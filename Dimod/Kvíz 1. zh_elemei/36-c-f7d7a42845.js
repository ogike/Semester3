(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[36],{"+XDm":function(e,t,i){t=e.exports=i("JPst")(false)
var n=i("HeW1")
var o=n(i("uCtj"))
var a=n(i("ldnB"))
var r=n(i("md8m"))
...
null!=a&&(n[a]=true)}for(var r=0;r<e.length;r++){var s=e[r]
if(null==s[0]||!n[s[0]]){i&&!s[2]?s[2]=i:i&&(s[2]="(".concat(s[2],") and (").concat(i,")"))
t.push(s)}}}
return t}
...
this.element.attr("aria-valuenow",e)}})},Mn3D:function(e,t,i){var n=i("UYA0")
...
break
case"vimeo":var _=p+"_player"
f.vimeoid=e.url.substr(e.url.lastIndexOf("/")+1)
h.innerHTML='<iframe src="'+e.scheme+"player.vimeo.com/video/"+f.vimeoid+"?api=1&portrait=0&byline=0&title=0&player_id="+_+'" width="'+c+'" height="'+m+'" frameborder="0" class="mejs-shim" id="'+_+'" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'
...
t.duration=o.duration=n.duration}t.dispatchEvent(o)}x.addEvent("play",(function(){T=1
e(x,f,"play")
e(x,f,"playing")}))
...
void 0===e.en&&(e.en={"mejs.plural-form":1,"mejs.download-file":"Download File","mejs.fullscreen-off":"Turn off Fullscreen","mejs.fullscreen-on":"Go Fullscreen","mejs.download-video":"Download Video","mejs.fullscreen":"Fullscreen","mejs.time-jump-forward":["Jump forward 1 second","Jump forward %1 seconds"],"mejs.play":"Play","mejs.pause":"Pause","mejs.close":"Close","mejs.time-slider":"Time Slider","mejs.time-help-text":"Use Left/Right Arrow keys to advance one second, Up/Down arrows to advance ten seconds.","mejs.time-skip-back":["Skip back 1 second","Skip back %1 seconds"],"mejs.captions-subtitles":"Captions/Subtitles","mejs.none":"None","mejs.mute-toggle":"Mute Toggle","mejs.volume-help-text":"Use Up/Down Arrow keys to increase or decrease volume.","mejs.unmute":"Unmute","mejs.mute":"Mute","mejs.volume-slider":"Volume Slider","mejs.video-player":"Video Player","mejs.audio-player":"Audio Player","mejs.ad-skip":"Skip ad","mejs.ad-skip-info":["Skip in 1 second","Skip in %1 seconds"],"mejs.source-chooser":"Source Chooser"})})(n.i18n.locale.strings)},O3h1:function(e,t,i){var n={"./me-i18n-locale-cs":["Zjte",168],"./me-i18n-locale-cs.js":["Zjte",168],"./me-i18n-locale-de":["C7He",169],"./me-i18n-locale-de.js":["C7He",169],"./me-i18n-locale-en":["tYpR",170],"./me-i18n-locale-en.js":["tYpR",170],"./me-i18n-locale-es":["KY2I",171],"./me-i18n-locale-es.js":["KY2I",171],"./me-i18n-locale-fr":["HiGp",172],"./me-i18n-locale-fr.js":["HiGp",172],"./me-i18n-locale-hu":["/Xzx",173],"./me-i18n-locale-hu.js":["/Xzx",173],"./me-i18n-locale-it":["bsL9",174],"./me-i18n-locale-it.js":["bsL9",174],"./me-i18n-locale-ja":["aVOL",175],"./me-i18n-locale-ja.js":["aVOL",175],"./me-i18n-locale-ko":["xv0d",176],"./me-i18n-locale-ko.js":["xv0d",176],"./me-i18n-locale-nl":["GE+S",177],"./me-i18n-locale-nl.js":["GE+S",177],"./me-i18n-locale-pl":["x7au",178],"./me-i18n-locale-pl.js":["x7au",178],"./me-i18n-locale-pt":["on1a",180],"./me-i18n-locale-pt-br":["OMPk",179],"./me-i18n-locale-pt-br.js":["OMPk",179],"./me-i18n-locale-pt.js":["on1a",180],"./me-i18n-locale-ro":["Wvze",181],"./me-i18n-locale-ro.js":["Wvze",181],"./me-i18n-locale-ru":["5Xva",182],"./me-i18n-locale-ru.js":["5Xva",182],"./me-i18n-locale-sk":["jZcU",183],"./me-i18n-locale-sk.js":["jZcU",183],"./me-i18n-locale-zh":["s1kf",185],"./me-i18n-locale-zh-cn":["s2+q",184],"./me-i18n-locale-zh-cn.js":["s2+q",184],"./me-i18n-locale-zh.js":["s1kf",185]}
...
function n(e){const t=new URL(e,window.location.origin)
...
i=d||(d=b(t))
n=x.bind(null,i,r,false)
o=x.bind(null,i,r,true)}else if(e.sourceMap&&"function"===typeof URL&&"function"===typeof URL.createObjectURL&&"function"===typeof URL.revokeObjectURL&&"function"===typeof Blob&&"function"===typeof btoa){i=v(t)
n=S.bind(null,i,t)
o=function(){g(i)
...
n(e=t)}else o()}}var w=(_=[],function(e,t){_[e]=t
return _.filter(Boolean).join("\n")})
var _
function x(e,t,i,n){var o=i?"":n.css
if(e.styleSheet)e.styleSheet.cssText=w(t,o)
else{var a=document.createTextNode(o)
var r=e.childNodes
r[t]&&e.removeChild(r[t])
r.length?e.insertBefore(a,r[t]):e.appendChild(a)}}function T(e,t){var i=t.css
var n=t.media
...
var n=i("pQTu")
var o=i("m0r6")
Object(o["a"])(JSON.parse('{"de":{"are_you_sure_you_want_to_delete_this_track_f5a16357":"Möchten Sie diese Spur wirklich löschen?","captions_subtitles_af2c47e":"Untertitel","delete_track_fc21128b":"Spur löschen"}}'))
i("jQeR")
i("0sPK")
var a=n["default"].scoped("mepfeaturetracksinstructure")
i("5Ky4")
...
Promise.all([i.e(1),i.e(520)]).then(i.bind(null,"z8T/")).then(e=>{let i=e.default
...
let e,t=this,i=t.selectedTrack,n=function(e){const t=new DOMParser
...
for(let t=0,n=i.length;t<n;t++)i[t].name.startsWith("on")||i[t].value.startsWith("javascript")?a[e].parentNode.removeChild(a[e]):"style"===i[t].name&&a[e].removeAttribute(i[t].name)}return i.body.innerHTML}
if(null!==i&&i.isLoaded){for(e=0;e<i.entries.times.length;e++)if(t.media.currentTime>=i.entries.times[e].start&&t.media.currentTime<=i.entries.times[e].stop){t.captionsText.html(n(i.entries.text[e])).attr("class","mejs-captions-text "+(i.entries.times[e].identifier||""))
...
o.chapters.append(e('<div class="mejs-chapter" rel="'+t.entries.times[i].start+'" style="left: '+r.toString()+"%;width: "+a.toString()+'%;"><div class="mejs-chapter-block'+(i==t.entries.times.length-1?" mejs-chapter-block-last":"")+'"><span class="ch-title">'+t.entries.text[i]+'</span><span class="ch-time">'+mejs.Utility.secondsToTimeCode(t.entries.times[i].start,o.options)+"&ndash;"+mejs.Utility.secondsToTimeCode(t.entries.times[i].stop,o.options)+"</span></div></div>"))
...
var n=i("pQTu")
var o=i("m0r6")
Object(o["a"])(JSON.parse('{"de":{"jquery_media_comments":{"loading":"Medien werden geladen ...","media_still_converting":"Die Medien werden derzeit konvertiert. Versuchen Sie es in Kürze erneut.","titles":{"play_comment":"Medienkommentar wiedergeben"}},"media_has_been_queued_for_conversion_please_try_ag_74343bbd":"Das Medium befindet sich zur Umwandlung in der Warteschlange. Bitte später noch einmal versuchen.","play_media_comment_8614d30f":"Medienkommentar wiedergeben"},"hu":{"jquery_media_comments":{"loading":"Média betöltése...","media_still_converting":"A médiafájlt éppen konvertáljuk, kérjük, egy kis idő múlva próbálja újra.","titles":{"play_comment":"Médiatartalom lejátszása"}},"media_has_been_queued_for_conversion_please_try_ag_74343bbd":"A média a konverziós sorba került, kérjük várjon a feldolgozás végéig","play_media_comment_8614d30f":"Médiatartalom lejátszása"}}'))
i("jQeR")
i("0sPK")
var a=n["default"].scoped("jquery_media_comments")
var r=i("GLiE")
var s=i.n(r)
var l=i("teYS")
var d=i.n(l)
...
const n=e.index(i)
return n<0?0:n}function g(e,t,i,n){this.player=t
this.media=i
this.event=n
...
const n=m()(t.captionsButton).find(".mejs-captions-selector input[type=radio]")
const o=h(n,(e,i)=>"none"===i.value&&null==t.selectedTrack||t.selectedTrack&&i.value===t.selectedTrack.srclang)
switch(this.keyCode){case p.DOWN:e=Math.min(o+1,n.length-1)
...
const n=h(i,(e,i)=>i.value===t.media.src)
switch(this.keyCode){case p.DOWN:e=Math.min(n+1,i.length-1)
...
const n=h(i,(e,i)=>parseFloat(i.value)===t.media.playbackRate)
switch(this.keyCode){case p.DOWN:e=Math.min(n+1,i.length-1)
i.slice(e).first().focus().click()
break
case p.UP:e=Math.max(n-1,0)
...
let n
let o
switch(this.keyCode){case p.LEFT:case p.G_REWIND:n=Math.max(t.currentTime-e.options.defaultSeekBackwardInterval(t),0)
t.setCurrentTime(n)
break
case p.RIGHT:case p.G_FORWARD:n=Math.min(t.currentTime+e.options.defaultSeekForwardInterval(t),t.duration)
t.setCurrentTime(n)
break
case p.PAGE_DOWN:n=Math.max(t.currentTime-e.options.defaultJumpBackwardInterval(t),0)
t.setCurrentTime(n)
break
case p.PAGE_UP:n=Math.min(t.currentTime+e.options.defaultJumpForwardInterval(t),t.duration)
t.setCurrentTime(n)
break
...
var v=i("5Ky4")
var y=i("Vj0+")
const j={getElement(e,t,i,n){const o="video"===e?' width="'.concat(i,'" height="').concat(n,'"'):""
const a="<".concat(e," ").concat(o,' preload="metadata" controls>').concat(t,"</").concat(e,">")
return m()(a)}}
const k=550
const w=448
m.a.extend(u["a"].MediaElementDefaults,{pluginPath:"/images/mediaelement/",defaultVideoWidth:k,defaultVideoHeight:w})
u["a"].MepDefaults.success=function(e,t){i.e(585).then(i.bind(null,"ozaW")).then(t=>{let i=t.default
i(this.mediaCommentId,e,INST.kalturaSettings)})
return e.play()}
u["a"].MepDefaults.features.push("googleanalytics")
const _=u["a"].MepDefaults.features.indexOf("tracks")+1
u["a"].MepDefaults.features.splice(_,0,"sourcechooser")
u["a"].MepDefaults.features.splice(_,0,"speed")
...
const n=s.a.map(e.media_tracks,e=>{const t=u["a"].language.codes[e.locale]||e.locale
...
return t}function T(e){let t=e.sourcesAndTracks,i=e.mediaType,n=e.height,o=e.width,a=e.mediaPlayerOptions
let r="video"===i?"video":"audio"
const s=t.sources.concat(t.tracks).join("")
function l(){const e=m.a.extend({mode:"auto"},u["a"].MediaElementDefaults,u["a"].MepDefaults,a)
const t=j.getElement("audio",s)
...
a.mode="auto_plugin"
a.isVideo=false
a.videoHeight=n=30}return j.getElement(r,s,o,n)}const S={create(e,t,i,n){m()("#media_recorder_container").removeAttr("id")
...
const n=m()(this).closest(".instructure_file_link_holder").andSelf().first()
n.text(a.t("loading","Loading media..."))
const o=function(e,i){const n=Math.min(i.closest("div,p,table").width()||k,k)
const o=Math.round(n/336*240)
return x(e).done(r=>{if(r.sources.length){const a={can_add_captions:r.can_add_captions,mediaCommentId:e,googleAnalyticsTitle:e,menuTimeoutMouseLeave:50,success(e){i.focus()
e.play()},keyActions:[{keys:s.a.values(b.keyCodes),action(e,t,i,n){if(e.isVideo){e.showControls()
e.startControlsTimer()}const o=new b(u["a"],e,t,n)
o.dispatch()}}]}
const l=T({sourcesAndTracks:r,mediaPlayerOptions:a,mediaType:t,height:o,width:n})
l.appendTo(i.html(""))
const d=new MediaElementPlayer(l,a)
l.data("mediaelementplayer",d)}else i.text(a.t("media_still_converting","Media is currently being converted, please try again in a little bit."))})}
if("maybe"===e){const e=i.replace(/\/download.*/,"")
const t=()=>n.text(a.t("Media has been queued for conversion, please try again in a little bit."))
...
return m.a.ajaxJSON(e,"GET",{},r,t)}return o(e,n)},show(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"video"
...
s.dialog({dialogClass:"play_media_comment",title:a.t("titles.play_comment","Play Media Comment"),width:r,height:o+60,modal:false,resizable:false,close:()=>{const e=n.data("mediaelementplayer")
e&&e.pause()
i&&i.focus()},open:e=>{m()(e.currentTarget).closest(".ui-dialog").attr("role","dialog").attr("aria-label",a.t("Play Media Comment"))
m()(e.currentTarget).parent().find(".ui-dialog-titlebar-close").focus()}})
return s.disableWhileLoading(x(e).done(i=>{if(i.sources.length){const a={can_add_captions:i.can_add_captions,mediaCommentId:e,googleAnalyticsTitle:e}
const l=T({sourcesAndTracks:i,mediaPlayerOptions:a,mediaType:t,height:o,width:r})
l.appendTo(s.html(""))
n.data({mediaelementplayer:new MediaElementPlayer(l,a),media_comment_dialog:s})}else s.text(a.t("media_still_converting","Media is currently being converted, please try again in a little bit."))}))}o.dialog("open")}}
...
let f
c.a.mediaComment=function(e,t,i){const n=c()("<div/>")
c()("body").append(n.hide())
c.a.fn.mediaComment.apply(n,arguments)}
...
i&&c.a.ajaxJSON("/media_objects","POST",{id:e.entryId,type:n,context_code:i,title:e.title,user_entered_title:e.userTitle},e=>{d.a.publish("media_object_created",e)},c.a.noop)
d.a.publish("media_comment_created",{id:e.entryId,mediaType:n,title:e.userTitle})}const g={}
c.a.mediaComment.entryAdded=function(e,t,i,n){if(!e||g[e])return
g[e]=true
...
c()("#media_upload_submit").attr("disabled",true).text(a.t("messages.submitting","Submitting Media File..."))
...
if(i.bytesTotal>INST.kalturaSettings.max_file_size_bytes){c()("#media_upload_feedback_text").html(a.t("errors.file_too_large","*This file is too large.* The maximum size is %{size}MB.",{size:INST.kalturaSettings.max_file_size_bytes/1048576,wrapper:"<b>$1</b>"}))
...
const i=t[0]
c()("#media_upload_submit").text(a.t("messages.submitted","Submitted Media File!"))
setTimeout(()=>{c()("#media_comment_dialog").dialog("close")},1500)
"audio"==e?i.entryType=5:"video"==e&&(i.entryType=1)
c.a.mediaComment.entryAdded(i.entryId,i.entryType,i.title)},progressHandler(e,t,i,n){const o=100*t/i
c()("#media_upload_progress").progressbar("option","value",o)},uploadErrorHandler(e){const t=c()("#"+e+"_upload")[0].getError()
c()("#media_upload_errors").text(a.t("errors.upload_failed","Upload failed with error:")+" "+t)
c()("#media_upload_progress").hide()},setupErrorHandler(){c()("#media_upload_feedback_text").text(a.t("errors.media_comment_installation_broken","Media comment uploading has not been set up properly. Please contact your administrator."))
c()("#media_upload_feedback").css("visibility","visible")
c()("#audio_upload_holder").css("visibility","hidden")
c()("#video_upload_holder").css("visibility","hidden")}}
let b=false
let v=null
c.a.mediaComment.init=function(e,t){Promise.all([i.e(1),i.e(17),i.e(63),i.e(294)]).then((()=>{const n=i("ufgb")
v=v||new Date
e=e||"any"
t=t||{}
let o=c.a.trim(c()("#identity .user_name").text()||"")
o&&(o=o+": "+(new Date).toString("ddd MMM d, yyyy"))
const r=t.defaultTitle||o||a.t("titles.media_contribution","Media Contribution")
...
d.dialog({title:a.t("titles.record_upload_media_comment","Record/Upload Media Comment"),width:560,height:475,modal:true})
...
c()("#audio_record").text(a.t("messages.flash_required_record_audio","Flash required for recording audio."))
...
c()("#audio_upload").text(a.t("messages.flash_required_upload_audio","Flash required for uploading audio."))
var m="180"
var p="50"
n.embedSWF("//"+INST.kalturaSettings.domain+"/kupload/ui_conf_id/"+INST.kalturaSettings.upload_ui_conf,"audio_upload",m,p,"9.0.0",false,l,u)
l=c.a.extend({},l,{jsDelegate:"$.mediaComment.video_delegate"})
c()("#video_upload").text(a.t("messages.flash_required_upload_video","Flash required for uploading video."))
m="180"
p="50"
n.embedSWF("//"+INST.kalturaSettings.domain+"/kupload/ui_conf_id/"+INST.kalturaSettings.upload_ui_conf,"video_upload",m,p,"9.0.0",false,l,u)
let h,g,v
let y,j
let k,w,_
let x,T
b=true
setInterval(()=>{if(b){h=c()("#audio_record_holder")
g=c()("#audio_record")
v=c()("#audio_record_meter")
y=0
j=0
k=c()("#video_record_holder")
w=c()("#video_record")
_=c()("#video_record_meter")
x=0
T=0
b=false}y++
x++
...
w&&w[0]&&w[0].getMicophoneActivityLevel&&w.parent().length?t=w[0].getMicophoneActivityLevel():w=c()("#video_record")
if(null!=e){e=Math.max(e,j)
if(e>-1&&!h.hasClass("with_volume")){v.css("display","none")
c()("#audio_record_holder").addClass("with_volume").animate({width:420},()=>{v.css("display","")})}if(y>4){j=0
y=0
var i=(e-e%10)/10
v.attr("class","volume_meter band_"+i)}else j=e}if(null!=t){t=Math.max(t,T)
if(t>-1&&!k.hasClass("with_volume")){_.css("display","none")
c()("#video_record_holder").addClass("with_volume").animate({width:420},()=>{_.css("display","")})}if(x>4){T=0
x=0
i=(t-t%10)/10
_.attr("class","volume_meter band_"+i)}else T=t}},20)}
if(INST.kalturaSettings.js_uploader){const n=p(i("im2D"))
f=new n(e,t)
f.onReady=s
f.addEntry=h
const o=i("agZB").getBrowser
const a=o();("Chrome"===a.name&&Number(a.version)>=68||"Firefox"===a.name&&Number(a.version)>=61)&&Promise.all([i.e(3),i.e(4),i.e(5),i.e(6),i.e(12),i.e(16),i.e(81),i.e(92),i.e(493)]).then(i.bind(null,"kImW")).then(e=>{let t=e.default
let i
const n=()=>{const e=document.getElementById("record_media_tab")
if(e){t(e,f.doUploadByFile)
clearInterval(i)}}
i=setInterval(n,10)})}const l=new Date
l-v>3e5&&c()("#media_comment_dialog").dialog("close").remove()
v=l
...
e.text(a.t("messages.loading","Loading..."))
e.dialog({title:a.t("titles.record_upload_media_comment","Record/Upload Media Comment"),resizable:false,width:470,height:300,modal:true})
c.a.ajaxJSON("/api/v1/services/kaltura_session","POST",{},t=>{e.data("ks",t.ks)
e.data("uid",t.uid)},t=>{false==t.logged_in?e.data("ks-error",a.t("errors.must_be_logged_in","You must be logged in to record media.")):e.data("ks-error",a.t("errors.load_failed","Media Comment Application failed to load.  Please try again."))})
...
c()("#media_upload_submit").text(a.t("buttons.submit","Submit Media File")).attr("disabled",true)
...
1==n.entryType&&c()("#audio_record_option").hasClass("selected_option")&&(n.entryType=5)
c.a.mediaComment.entryAdded(n.entryId,n.entryType,n.entryName,t)
...
e.exports={subscribe:o,unsubscribe:a,publish:r}},uCtj:function(e,t,i){e.exports=i.p+"746c3af7a145a09239a36e5ef61cfea0.svg"},ucra:function(e,t){function i(e,t,i){if(!isNaN(t.duration)&&t.duration>0){if(e.isVideo){e.showControls()
...
//# sourceMappingURL=36-c-f7d7a42845.js.map
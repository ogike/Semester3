...
public class CalcGUI {
    ...
    public CalcGUI(int fieldWidth) {
        ...
        frame.pack(); //e nélkül nagyon bugos lesz!
        frame.setVisible(true);
    }

    //inside class: magában a CalcGUI class-on belül van definiálva
        //actionListenerekre általában jó
    class CalcActionListener implements ActionListener {
        ...
        @Override //ezt kell nekünk definiálni
        public void actionPerformed(ActionEvent ae) {
            try {

...
public class MainWindow extends JFrame {
    ...
    private boolean changed = false; //lehet-e menteni?

    private Timer moveChecker; //5mp-ig nem csinál a felhasználó baszogassa
    private Timer clock;
    ...
    public MainWindow() {
        ...
        //mi magunk kezeljük a kilpépst a fenti alapján
    ...
    private void addButton(JPanel mainPanel, int i, int j) {
        ...
        grid[i][j].addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                switch (e.getButton()) {
                    case MouseEvent.BUTTON1: //balklikk
                        model.nextNumber(i, j);
                        updateTextOfButton(i, j);
                        break;
                    case MouseEvent.BUTTON3: //jobbklikk
                        model.clear(i, j);
                        updateTextOfButton(i, j);
                        break;
                }

...
var G=(v=Object(f["a"])("7.0.0",null,"Use Text from ui-text instead."),U=Object(y["themeable"])(j,B),v(k=U(k=(x=w=function(e){Object(l["a"])(t,e)
...
var n=this.props,r=n.wrap,a=n.weight,i=n.fontStyle,c=n.size,l=n.lineHeight,b=n.letterSpacing,d=n.transform,u=n.color,p=n.children
var y=Object(m["a"])(t,this.props)
return s.a.createElement(y,Object.assign({},Object(g["a"])(this.props,t.propTypes),{className:h()((e={},Object(o["a"])(e,B.root,true),Object(o["a"])(e,B[c],c),Object(o["a"])(e,B["wrap-".concat(r)],r),Object(o["a"])(e,B["weight-".concat(a)],a),Object(o["a"])(e,B["style-".concat(i)],i),Object(o["a"])(e,B["transform-".concat(d)],d),Object(o["a"])(e,B["lineHeight-".concat(l)],l),Object(o["a"])(e,B["letterSpacing-".concat(b)],b),Object(o["a"])(e,B["color-".concat(u)],u),e)),ref:this.props.elementRef}),p)}}])
t.displayName="Text"
...
function t(){Object(r["a"])(this,t)
return Object(i["a"])(this,Object(c["a"])(t).apply(this,arguments))}Object(a["a"])(t,[{key:"render",value:function(){return s.a.createElement(d["a"],Object.assign({},this.props,{name:"IconCheckMark",viewBox:"0 0 1920 1920"}),u)}}])
t.displayName="IconCheckMarkSolid"
return t}(b["Component"])
p.glyphName="check-mark"
p.variant="Solid"
p.propTypes=Object(o["a"])({},d["a"].propTypes)},"M8//":function(e,t,n){"use strict"
var o=n("rePB")
var r=n("1OyB")
var a=n("vuIU")
var i=n("md7G")
...
var T=(C=Object(G["a"])(),z=Object(B["themeable"])(S,M),C(L=z(L=(R=H=function(e){Object(b["a"])(t,e)
function t(){var e
Object(r["a"])(this,t)
...
var r=Object(x["a"])(e.props.maxHeight,Object(g["a"])(Object(l["a"])(e)))
...
else if(Object(x["a"])(e.props.height,Object(g["a"])(Object(l["a"])(e)))>e._textarea.scrollHeight){e._textarea.style.overflowY="auto"
o=e.props.height}var a=Object(x["a"])(o)>r
...
var r=this.props,a=r.autoGrow,i=r.placeholder,c=r.value,l=r.defaultValue,b=r.disabled,s=r.readOnly,u=r.required,p=r.width,h=r.height,f=r.maxHeight,g=r.textareaRef,_=r.resize,j=r.size
...
var k={width:p,resize:_,height:a?null:h,maxHeight:f}
...
if(i)return i
if(o[r]&&"function"!==typeof o[t])return new Error(["You provided a '".concat(r,"' prop without an '").concat(t,"' handler on '").concat(a,"'. This will render a controlled component. If the component should be uncontrolled and manage its own state, use '").concat(n,"'. Otherwise, set '").concat(t,"'.")].join(""))}}}}])

//# sourceMappingURL=10-c-d22ff3793f.js.map
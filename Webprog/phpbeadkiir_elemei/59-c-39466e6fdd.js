(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[59],{"/HcR":function(r,n,a){"use strict"
var e=a("O92E")
var t=a("2bDf")
var i=a("IYu7")
var o=a("V3mB")
...
while(r.index<e){if(a[r.index]===t){if(!n)throw D(r)
...
return[o]}var a=y(r)
if(a)return a
if(n[r.index]!==e)throw D(r,e)
r.tokens&&r.tokens.push(["syntax",e]);++r.index
x(r)
var l=k(r)
if(!l)throw D(r,"placeholder id")
r.tokens&&r.tokens.push(["id",l])
x(r)
var c=n[r.index]
if(c===t){r.tokens&&r.tokens.push(["syntax",t]);++r.index
return[l]}if(c!==i)throw D(r,i+" or "+t)
r.tokens&&r.tokens.push(["syntax",i]);++r.index
x(r)
var u=k(r)
if(!u)throw D(r,"placeholder type")
r.tokens&&r.tokens.push(["type",u])
x(r)
c=n[r.index]
if(c===t){r.tokens&&r.tokens.push(["syntax",t])
if("plural"===u||"selectordinal"===u||"select"===u)throw D(r,u+" sub-messages");++r.index
return[l,u]}if(c!==i)throw D(r,i+" or "+t)
r.tokens&&r.tokens.push(["syntax",i]);++r.index
x(r)
var s
if("plural"===u||"selectordinal"===u){var d=M(r)
x(r)
s=[l,u,d,I(r,u)]}else if("select"===u)s=[l,u,I(r,u)]
...
var a=m(r,"{style}")
if(!a)throw D(r,"placeholder style name")
...
if(t===r.index)throw D(r,"offset number")
r.tokens&&r.tokens.push(["number",n.slice(t,r.index)])
e=+n.slice(t,r.index)}return e}function O(r){return r>=48&&r<=57}function I(r,n){var a=r.pattern
var e=a.length
var i={}
while(r.index<e&&a[r.index]!==t){var o=k(r)
if(!o)throw D(r,"sub-message selector")
r.tokens&&r.tokens.push(["selector",o])
x(r)
i[o]=j(r,n)
x(r)}if(!i.other&&h.indexOf(n)>=0)throw D(r,null,null,'"other" sub-message must be specified in '+n)
return i}function j(r,n){if(r.pattern[r.index]!==e)throw D(r,e+" to start sub-message")
r.tokens&&r.tokens.push(["syntax",e]);++r.index
var a=p(r,n)
if(r.pattern[r.index]!==t)throw D(r,t+" to end sub-message")
r.tokens&&r.tokens.push(["syntax",t]);++r.index
return a}function D(r,n,a,e){var t=r.pattern
...
n["default"]=o}).call(this,a("yLpj"),a("3UD+")(r))},syYy:function(r,n,a){"use strict"
var e=a("vAQ1")
var t=a("ZoNA")
...
//# sourceMappingURL=59-c-39466e6fdd.js.map